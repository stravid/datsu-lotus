...
module Datsu
  class Application < Lotus::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['DATSU_SESSIONS_SECRET']
      ...
      #
      # adapter type: :file_system, uri: ENV['DATSU_DATABASE_URL']
      ...
      #
      layout :application # It will load Datsu::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Datsu::Action is included
      ...
      # Configure the code that will yield each time Datsu::View is included
      # This is useful for sharing common functionality
      #
